...
public class cartaodedebito extends Conta{
	
	long numerodocartao;
	double custo;
	

	public cartaodedebito(String nomedapessoa, String sexodapessoa, String sexo2dapessoa, int idadedapessoa) {
	...
	public  void contaaordem () {
		...
		String consultarinformacao = "Consultar Informacao do Cliente";
		String consultarmoviementos ="Consultar movimentos da conta";
