...
public class plafondMensal extends cartaodedebito{

	public plafondMensal(String nomedapessoa, String sexodapessoa, String sexo2dapessoa, int idadedapessoa) {
	...
	public void pagamentosdocartao () {
	...
	double montanteapagaremprestimo;
	}
	
	public void pagamaneotsdoplafond () {
		String datadepagamento;	
		double montanteapagar;
		String mododepagamento1 = "Pagamento de Impostos";
		String mododepagamento2 = "Pagamento de Telecomunicacoes";
	...
	public void levantamentoscashadvance() {
		double levantamentosplafond20e = 20.00;
		double levantamentosplafond50e = 50.00;
		double levantamentoslplafond100e = 100.00;		
	}
